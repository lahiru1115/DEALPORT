// Generated from design/icons/image-outline.svg — do not edit by hand.
// Run `npm run icons:generate -w @dealport/web` to regenerate.
import type { SVGProps } from "react";

export function ImageOutlineIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 20 20"
      fill="none"
